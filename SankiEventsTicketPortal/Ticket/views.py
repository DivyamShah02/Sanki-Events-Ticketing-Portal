...
class ApproveTicketViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        mail_sent = self.send_mail(customer_name=ticket_data.customer_name,
                                    event_name=event_data_obj.event_name,
                                    ...
                                    event_banner=event_data_obj.event_banner)
    ...
    def send_mail(self, customer_name, event_name, date, recipient_email, qty, price, venue, event_banner):
