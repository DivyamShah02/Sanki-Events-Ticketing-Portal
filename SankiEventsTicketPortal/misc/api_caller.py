...
if __name__ == '__main__':
    ...
    # Create admin user
    # create_admin_user_response = create_admin_user()
    # print(create_admin_user_response.text)

    create_user_response = create_user('Vayu 25', '9054413199', 'vayu.25@sankievents.in')
