        ...
        if 'event_id' in representation:
            ...
            for event_date in event_dates:
                temp_event = {
                    ...
                    'available_tickets': int(event_date.total_number_of_tickets) - int(event_date.number_of_tickets)
                }
                all_dates.append(f'{event_date.date.day}/{event_date.date.month}')
                ...
                all_envents_tickets_sold_obj = Ticket.objects.filter(event_date_id=event_date.event_date_id)
                all_envents_tickets_sold = QtyAmountTicketSerializer(all_envents_tickets_sold_obj, many=True).data
